...
public class SmsController {
    ...
    public SmsController() {
        this.messageService = NurigoApp.INSTANCE.initialize("NCSHQJNQTHSEUIWB", "BNBCVMADH6UFVICOXCQZJNOJMCTPZJOQ", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne() {
        ...
        message.setFrom("01032772026");
        message.setTo("01032772026");
//        message.setText("한글 45자, 영자 90자 이하 입력되면 자동으로 SMS타입의 메시지가 추가됩니다.");
        message.setText("조건에 맞게 입력");
